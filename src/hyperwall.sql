...
-- Name: hyperwall; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE hyperwall WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';


ALTER DATABASE hyperwall OWNER TO postgres;
