package hyperwall.controller;

import hyperwall.entity.ArcGISLayer;
import hyperwall.entity.GeoJSONLayer;
import hyperwall.entity.MinimalGeoJSONLayer;
import hyperwall.repository.ArcGISLayerRepository;
import hyperwall.repository.GeoJSONLayerRepository;
import hyperwall.repository.MapLayerRepository;
import hyperwall.requestbody.AdminUIArcGISRequest;
import hyperwall.requestbody.AdminUILayerUploadRequest;
import hyperwall.requestbody.ArcGISTokenRequest;
import hyperwall.response.ArcGISToken;
import hyperwall.response.LayerResponse;
...
public class LayerController {
    ...
    public ResponseEntity<String> getArcGISToken() {
        ...
        request.setClientID("KocNqiWMdrCwAP8K");
        request.setClientSecret("d2ece1cc77ba4db1a4829fdf106c067d");
